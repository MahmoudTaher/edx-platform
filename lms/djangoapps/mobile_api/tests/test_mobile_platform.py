...
class TestMobilePlatform(TestCase):
    ...
    @ddt.data(
        ...
        ("edX/org.edx.mobile (3.3.3; OS Version 9.2 (Build 13C75))", "iOS", "3.3.3.test"),
        ...
        ("Dalvik/2.1.0 (Linux; U; Android 5.1; Nexus 5 Build/LMY47I) edX/org.edx.mobile/3.3.3", "Android", "3.3.3.RC"),
    )
    @ddt.unpack
